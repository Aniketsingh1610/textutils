    ...
    <div >
      <nav className={`navbar navbar-expand-lg bg-${props.mode}`}>
        <div className="container-fluid ">
          <a className={`navbar-brand text-${props.mode === 'light' ? 'dark' : 'light'}`} href="/">Textutiles</a>
...
Navbar.defaultProps = { title: 'Enter a title here', about: 'Enter a description here' }